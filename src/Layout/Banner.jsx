...
const Banner = () => {
  return (
    <div className='text-3xl text-center max-h-32 lg:min-h-44 flex items-center justify-between px-10 overflow-hidden'>
      <img src={NSSLogo} alt="Logo" />
      <div className="flex gap-5 items-center">
        <div className="text-end">
          <h1 className="text-3xl text-blue-900 font-semibold p-1">
