    ...
    <div className="">
      ...
      <div className="flex justify-center mt-10 py-10 bg-blue-900">
        <div className="flex w-[75%] items-center gap-8 ">
          ...
          <div className="group flex flex-col w-400 shadow-2xl">
            <div className="w-full overflow-clip duration-500">
              <img src={photoGalleryCover} className="group-hover:scale-110 object-cover duration-500" alt="Photo gallery cover" />
            </div>
            <a href="" className="hover:bg-red-700 duration-300 bg-red-600 flex-1 text-center py-2 text-white">Photo Gallery</a>
          </div>
          <div className="group flex flex-col w-400 shadow-2xl">
            <div className="w-full overflow-clip duration-500">
              <img src={videoGalleryCover} className="group-hover:scale-110 object-cover duration-500" alt="Video gallery cover" />
            </div>
