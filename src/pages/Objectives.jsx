        ...
        <SidebarMenu breadCrumb={[{label : "Home", path : '/'},{label : "Objectives", path : '/objectives'}]}>
            <div>
                ...
                <ul className='list-decimal text-lg list-inside mt-4'>
                    ...
                    <li className='mb-2'>develop among themselves a sense of social and civic responsibility</li>
                    <li className='mb-2'>utilise their knowledge in finding practical solutions to individual and community problems</li>
                    <li className='mb-2'>develop competence required for group-living and sharing of responsibilities</li>
                    <li className='mb-2'>gain skills in mobilising community participation</li>
                    <li className='mb-2'>acquire leadership qualities and democratic attitudes</li>
                    <li className='mb-2'>develop capacity to meet emergencies and natural disasters and</li>
                    <li className='mb-2'>practice national integration and social harmony</li>
                </ul>
            </div>
        </SidebarMenu>
    </div>
