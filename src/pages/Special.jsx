    ...
    <div className="bg-gray-100 w-screen">
      <div className="pt-10 w-[90%] md:w-[75%] mx-auto ">
        <SidebarMenu
          breadCrumb={[
            { label: "Home", path: "/" },
            { label: "Special Camps", path: "/specialCamp" },
          ]}
        >
          <div>
            <h1 className="text-3xl text-black/65">
            ...
            <section className="mb-8">
              ...
              <p className="mb-4">
                Special Camping contributes significantly to rural
                reconstruction and social development, with universities,
                colleges, and local authorities playing a crucial role.
              </p>
              <p>
                Camps are organized year after year in villages and urban slums
                to create tangible and durable community assets.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-decimal list-inside mb-4 space-y-2">
                ...
                <li>
                  Build potential youth leaders through involvement in
                  development projects.
                </li>
                <li>
                  Emphasize the dignity of labor and self-help, combining
                  physical work with intellectual pursuits.
                </li>
                <li>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  Production oriented programmes like soil-testing and pest
                  control
                </li>
                <li>
                ...
                <li>
                  Educational and recreational activities for the community
                </li>
              </ul>
            </section>
          </div>
