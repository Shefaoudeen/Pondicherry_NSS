                    ...
                    <table className='table-fixed' >
                        <thead>
                            <tr>
                                ...
                                <th className='md:w-3/12 border px-1 md:px-3 py-2 font-bold text-black/70 text-start'>Name, Designation & E-mail ID of Directorate of NSS</th>
                                <th className='md:w-1/12 border px-3 py-2 font-bold text-black/70 text-start'>State</th>
                                <th className='min-w-52 md:w-2/6 border px-3 py-2 font-bold text-black/70 text-start text-nowrap'>Office Address</th>
